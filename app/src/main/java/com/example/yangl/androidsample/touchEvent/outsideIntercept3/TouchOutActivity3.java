...
public class TouchOutActivity3 extends AppCompatActivity {


    private String TAG = "outsideIntercept3.InterceptActivity2";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_touch_out_3);
        viewGroupGet();
