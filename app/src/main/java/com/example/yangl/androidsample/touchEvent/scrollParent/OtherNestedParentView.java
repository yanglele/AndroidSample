 ...
 * update:
 */
public class OtherNestedParentView extends FrameLayout implements NestedScrollingParent {

    public static final String TAG = OtherNestedParentView.class.getSimpleName();

    private NestedScrollingParentHelper parentHelper;

    public OtherNestedParentView(Context context) {
        super(context);
    }

    public OtherNestedParentView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
