 ...
 * update:
 */
public class InterceptView2 extends View {
    private String TAG = "outsideIntercept4.InterceptView2";

    public InterceptView2(Context context) {
        super(context);
    }

    public InterceptView2(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public InterceptView2(Context context, AttributeSet attrs, int defStyleAttr) {
