 ...
 * update:
 */
public class OtherNestedChildView extends View implements NestedScrollingChild {
    ...
    public OtherNestedChildView(Context context) {
        super(context);
        init();
    }


    public OtherNestedChildView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
