...
import com.example.yangl.androidsample.IRecyclerViewSample.irecyclerCoordinatory.MRecyclerViewViewHolder;
...
public class SimpleRecyclerViewAdapter extends BaseAdapter<Object,BaseViewHolder> {

    private final int NORMAL_VIEW_HOLDER= R.layout.simple_text_view;

    public SimpleRecyclerViewAdapter(Context context, List list) {
        super(context, list);
    }
