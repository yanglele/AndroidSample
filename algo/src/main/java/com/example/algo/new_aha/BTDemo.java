...
//		System.out.println(isInTheTree(r1, r3));
	...
	public static void postorderTraversal(TreeNode root) {
		...
		while (!inNodes.isEmpty()) {
			...
			if (tmp.left != null)
				inNodes.add(tmp.left);
			if (tmp.right != null)
				inNodes.add(tmp.right);
		}
	...
	public static void getLastCommonParentRecSub1(TreeNode root, TreeNode n1, TreeNode n2, Integer level, int[] path1,
			int[] path2) {
		if (root == null)
			return;
